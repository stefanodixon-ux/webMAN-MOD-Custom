...
cls
title [1/2] Building webftp_server_lite.sprx...
...
cls
title [2/2] Building webftp_server_full.sprx...
copy .\flags\flags_full.h .\flags.h >nul
make>nul
if exist webftp_server.sprx ren webftp_server.sprx webftp_server.sprx
